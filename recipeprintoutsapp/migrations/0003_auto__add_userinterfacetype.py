...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recipeprintoutsapp_userinterfacetype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255)),
            ('redirection_url', self.gf('django.db.models.fields.CharField')(default=u'', max_length=255)),
        ))
        db.send_create_signal(u'recipeprintoutsapp', ['UserInterfaceType'])


    def backwards(self, orm):
        # Deleting model 'UserInterfaceType'
        db.delete_table(u'recipeprintoutsapp_userinterfacetype')
