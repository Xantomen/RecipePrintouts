...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field NutData_Link on 'Footnote'
        m2m_table_name = db.shorten_name(u'footnote_NutData_Link')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('footnote', models.ForeignKey(orm[u'recipeprintoutsapp.footnote'], null=False)),
            ('nutdata', models.ForeignKey(orm[u'recipeprintoutsapp.nutdata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['footnote_id', 'nutdata_id'])
        ...
        # Adding M2M table for field NutData_Link on 'FoodDes'
        m2m_table_name = db.shorten_name(u'food_des_NutData_Link')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fooddes', models.ForeignKey(orm[u'recipeprintoutsapp.fooddes'], null=False)),
            ('nutdata', models.ForeignKey(orm[u'recipeprintoutsapp.nutdata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fooddes_id', 'nutdata_id'])

        # Adding M2M table for field Langual_Link on 'FoodDes'
        m2m_table_name = db.shorten_name(u'food_des_Langual_Link')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fooddes', models.ForeignKey(orm[u'recipeprintoutsapp.fooddes'], null=False)),
            ('langual', models.ForeignKey(orm[u'recipeprintoutsapp.langual'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fooddes_id', 'langual_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field NutData_Link on 'Footnote'
        db.delete_table(db.shorten_name(u'footnote_NutData_Link'))
        ...
        # Removing M2M table for field NutData_Link on 'FoodDes'
        db.delete_table(db.shorten_name(u'food_des_NutData_Link'))

        # Removing M2M table for field Langual_Link on 'FoodDes'
        db.delete_table(db.shorten_name(u'food_des_Langual_Link'))
    ...
    models = {
        ...
        u'recipeprintoutsapp.fooddes': {
            ...
            'Langual_Link': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['recipeprintoutsapp.Langual']", 'null': 'True', 'blank': 'True'}),
            'Meta': {'object_name': 'FoodDes', 'db_table': "u'food_des'"},
            'NutData_Link': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['recipeprintoutsapp.NutData']", 'null': 'True', 'blank': 'True'}),
        ...
        u'recipeprintoutsapp.userinterfacetype': {
            'Meta': {'object_name': 'UserInterfaceType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255'}),
            'redirection_url': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255'})
        },
